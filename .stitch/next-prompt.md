...
page: vendors
---
A robust filtering sidebar and beautiful vendor cards for the vendors directory.
...
2. A hero banner saying "Discover our Curated Vendors"
3. A two-column layout:
   - Left Sidebar: Filters for Category (Venue, Catering, Decor), Location, Price Range, and Rating.
   - Right Main Content: A grid of premium Vendor Cards (image, title, rating, category badge, and a "View Details" button).
4. Footer
