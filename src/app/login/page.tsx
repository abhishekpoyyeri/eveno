...
<p className="font-body-md text-white/90">
                    ...
                    <button formAction={signup} type="submit" className="font-bold text-white underline underline-offset-4 decoration-secondary hover:text-secondary transition-colors ml-1">Sign Up</button>
</p>
</div>
</form>
</div>
